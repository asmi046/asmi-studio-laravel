...
<?php
	$pageTitle = "Кейс: Разработка сайта для сервиса дитейлинга Автотишина - Asmi-Studio";
	$pageDescription = "Проект по созданию сайта для сервиса детейлинга Автотишина. Разработка сайта каталога в Курске";
	$folder_name = "autotish";
	...
	<section class = "portfolio_section">
		<div class = "content">
			<div class = "breadcrumbs">
				<a href = "<?php echo $GLOBALS["url"]; ?>">Главная</a> / <a href = "<?php echo $GLOBALS["url"]; ?>/portfolio/">Портфолио</a> / Разработка сайта для сервиса дитейлинга Автотишина
			</div>
			<div class = "center portfolio_osnblk">
				<div class = "p_info">
					<h1>Сайт для сервиса по дитейлингу Автотишина</h1>
					<p>В ходе пректа создан корпоративный сайт с рубрицированным каталогом проведенных работ по шумоизоляции автомобилей.</p>
					<p>
					<span data-form = "Сайт Автотишина" class = "allBtn unisend_win">Хочу так же</span>
					</p>
				</div>
				<div class = "p_picture">
			...
			<div class = "center portfolio_all portfolio_colors">
				...
				<div class = "clrWraper">
					<div class = "colorBlk" style = "background-color:#ff9601;">#ff9601</div>
					<div class = "colorBlk" style = "background-color:#FFFFFF; border: 1px solid #28475C;">#FFFFFF</div>
					<div class = "colorBlk" style = "background-color:#848f92;color: #FFFFFF;">#848f92</div>
					<div class = "colorBlk" style = "background-color:#144970;color: white;">#144970</div>
				</div>
			</div>
			...
			<div class = "center portfolio_all portfolio_image portfolio_image_many">
				...
				<img src = "../img/portfolio/<?php echo $folder_name;?>/<?php echo $folder_name;?>-nature-2.<?php global $imgRaz; echo $imgRaz; ?>">
			</div>
		</div>
	</section>
